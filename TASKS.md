...
| B-1 | 【バグ】無音自動停止が発火しない（V1.5欠陥・effect churn でタイマー消滅） | TODO | Sonnet5 | 無音10分で確実に停止 / 揺れで計測が途切れない |
| V2.6 | E2E テスト（Playwright・偽造セッションで認証済みフローも） | TODO | Sonnet5 | 未認証リダイレクト/401/manifest/認証済みUI表示が green |
